...
/**
 * 添加FreeForm订单操作的controller。
 * @author Administrator
 *
 */
public class AddFreeFormOrderController extends SimpleFormController
{
	private static final Logger log = Logger.getLogger(
			"AddFreeFormOrderController", Logger.ALL, true);
	...
	{
		log.info("AddFreeFormOrderController formBackingObject...");
			...
			throws Exception
	{
		...
		log.info("AddFreeFormOrderController onSubmit...");
		...
		try
		{
			// 将form转换为实体，转换后的订单已经经过初始化，订单类型为FreeForm订单
			OrsOrder order = FormUtils.convertFreeFormOrderFrom(form, onlineOrder);
			// 缺省字段
			// 获取客户名称
