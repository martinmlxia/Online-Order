 ...
 * 
 */
public class ModifyFreeFormOrderController extends SimpleFormController
{
	private static final Logger log = Logger.getLogger(
			"ModifyFreeFormOrderController", Logger.ALL, true);
	...
	{
		log.info("ModifyFreeFormOrderController formBackingObject...");
	...
	protected ModelAndView onSubmit(HttpServletRequest request,
			...
			throws Exception
	{
		log.info("ModifyFreeFormOrderController onSubmit...");
