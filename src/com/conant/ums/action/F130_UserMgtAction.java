...
public class F130_UserMgtAction
    ...
    public String executeAct(Connection con,
        ...
        if (piForm.getOp().equals("insert") == true) {
            ...
            piForm.setBusinessName(BytesConverter.asc2gb(userData.getBusinessName()));
            piForm.setBusinessStreetName(BytesConverter.asc2gb(userData.getBusinessStreetName()));
            piForm.setBusinessStreetNumber(BytesConverter.asc2gb(userData.getBusinessStreetNumber()));
            piForm.setBusinessSuit(BytesConverter.asc2gb(userData.getBusinessSuit()));
            piForm.setBusinessCity(BytesConverter.asc2gb(userData.getBusinessCity()));
            piForm.setLastName(BytesConverter.asc2gb(userData.getLastName()));
            ...
            if (selectresult.size() <= 0) {
                ...
                piForm.setBusinessCity(pnLData.getBusinessCity());
                piForm.setBusinessCountry(pnLData.getBusinessCountry());
                piForm.setBusinessFax(pnLData.getBusinessFax());
                piForm.setBusinessName(pnLData.getBusinessName());
                piForm.setBusinessPhone(pnLData.getBusinessPhone());
                piForm.setBusinessState(pnLData.getBusinessState());
                piForm.setBusinessStreetName(pnLData.getBusinessStreetName());
                piForm.setBusinessStreetNumber(pnLData.getBusinessStreetNumber());
                piForm.setBusinessSuit(pnLData.getBusinessSuit());
                piForm.setLastName(pnLData.getLastName());
                httpServletRequest.setAttribute("Business_State", pnLData.getBusinessState());
                httpServletRequest.setAttribute("Business_Country", pnLData.getBusinessCountry());
