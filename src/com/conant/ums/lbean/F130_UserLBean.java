...
public class F130_UserLBean
    ...
    public int insertData(Connection oConn, F130_UserMgt userData) throws
        ...
        String sFieldName = " (user_id, user_tag, user_name, user_passwd, email, address, home_tel, mobile,businessPhone,businessFax,businessName,businessStreetNumber,businessStreetName,businessSuit,businessCity,businessState,businessCountry,lastName, add_date, add_userid)";
        String sValue = "(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public int updateData(Connection oConn, F130_UserMgt userData) throws
        ...
        sql = sql +
            "email = ?, address = ?, home_tel = ?, mobile = ?, businessPhone=?,businessFax=?,businessName=?,businessStreetNumber=?,businessStreetName=?,businessSuit=?,businessCity=?,businessState=?,businessCountry=?,lastName=?,upd_date = ?, upd_userid = ? where user_id = ? ";
    ...
    public List selectRecord(Connection oConn, F130_UserMgt prm_Data,
        ...
        try {
            while (rs.next()) {
                ...
                f130_UserMgt.setBusinessCity(ComString.nvl(rs.getString("businessCity")));
                f130_UserMgt.setBusinessCountry(ComString.nvl(rs.getString("businessCountry")));
                f130_UserMgt.setBusinessFax(ComString.nvl(rs.getString("businessFax")));
                f130_UserMgt.setBusinessName(ComString.nvl(rs.getString("businessName")));
                f130_UserMgt.setBusinessPhone(ComString.nvl(rs.getString("businessPhone")));
                f130_UserMgt.setBusinessState(ComString.nvl(rs.getString("businessState")));
                f130_UserMgt.setBusinessStreetName(ComString.nvl(rs.getString("businessStreetName")));
                f130_UserMgt.setBusinessStreetNumber(ComString.nvl(rs.getString("businessStreetNumber")));
                f130_UserMgt.setBusinessSuit(ComString.nvl(rs.getString("businessSuit")));
                f130_UserMgt.setLastName(ComString.nvl(rs.getString("lastName")));
    ...
    public List selectRecordSelect(Connection oConn, F130_UserMgt prm_Data) throws
        ...
        try {
            while (rs.next()) {
                ...
                f130_UserMgt.setAdd_date(rs.getString("add_date"));
                f130_UserMgt.setDept_name(userDeptName(oConn, f130_UserMgt.getUser_id()));
                f130_UserMgt.setBusinessCity(rs.getString("businessCity").trim());
                f130_UserMgt.setBusinessCountry(rs.getString("businessCountry").trim());
                f130_UserMgt.setBusinessFax(rs.getString("businessFax").trim());
                f130_UserMgt.setBusinessName(rs.getString("businessName").trim());
                f130_UserMgt.setBusinessPhone(rs.getString("businessPhone").trim());
                f130_UserMgt.setBusinessState(rs.getString("businessState").trim());
                f130_UserMgt.setBusinessStreetName(rs.getString("businessStreetName").trim());
                f130_UserMgt.setBusinessStreetNumber(rs.getString("businessStreetNumber").trim());
                f130_UserMgt.setBusinessSuit(rs.getString("businessSuit").trim());
                f130_UserMgt.setLastName(rs.getString("lastName").trim());
    ...
    public void setUserData(PreparedStatement pstmt,
        ...
        pstmt.setString(temp++, userData.getBusinessPhone());
        pstmt.setString(temp++, userData.getBusinessFax());
        pstmt.setString(temp++, BytesConverter.asc2gb(userData.getBusinessName()));
        pstmt.setString(temp++, BytesConverter.asc2gb(userData.getBusinessStreetNumber()));
        pstmt.setString(temp++, BytesConverter.asc2gb(userData.getBusinessStreetName()));
        pstmt.setString(temp++, BytesConverter.asc2gb(userData.getBusinessSuit()));
        pstmt.setString(temp++, BytesConverter.asc2gb(userData.getBusinessCity()));
        pstmt.setString(temp++, userData.getBusinessState());
        pstmt.setString(temp++, userData.getBusinessCountry());
        pstmt.setString(temp++, BytesConverter.asc2gb(userData.getLastName()));
