      ...
      if(!focus){
		...
		if(isBlank(theZip)){
				...
				if(theZip.length == 10){
						...
						if( theZip.length < 5 || (theZip.length > 5 && theZip.length  < 9) || theZip.length  > 10){
								buserror = buserror + '<font face="Arial" size="1" color="#333333">The ZIP CODE must have either 5 or 9 numbers.</font><br>';
								buserrbool = true;
								founderr = true;
						}else{
								if(!isNumeric(theZip)){
		...
		<table cellspacing="0" cellpadding="0" border="0" width="630">
			<tr>
				...
				<table cellspacing="0" cellpadding="0" border="0" width="800">
					<tr>
						<td align="center">
						<table cellspacing="0" cellpadding="2" border="0" width="800" bgcolor="#416C97" class="pagetitlebar" background="<c:url value="/resources/images/bg.jpg"/>">
							<tr>
								<td>
								<table cellspacing="0" cellpadding="2" border="0" width="800" height="80">
									<tr>
										<td width="50%">
										<div id="log" style="padding-left: 2px;" align="center">
											<span class="STYLE2">
				...
				<table cellspacing="0" cellpadding="2" border="0" width="800" bgcolor="#687A96">
					<tr>
				...
				<table cellspacing="0" cellpadding="3" border="0" width="800" bgcolor="#bbbbbb" class="border">
					<tr>
						<td>
						<table cellspacing="0" cellpadding="0" border="0" bgcolor="#dddddd">
							<tr>
								<td>
								<table cellspacing="2" cellpadding="0" border="0" bgcolor="#dddddd" width="794">
									<tr align="left">
										<td width="500">
				...
				<table cellspacing="0" cellpadding="3" border="0" width="800" bgcolor="#bbbbbb" class="border">
					<tr>
						...
						<table cellspacing="0" cellpadding="0" border="0" bgcolor="#dddddd">
							<tr>
								<td>
								<table cellspacing="2" cellpadding="0" border="0" bgcolor="#eeeeee" width="794">
									<tr>
										<td align="left">
										<div align="justify">
						...
						<table cellspacing="0" cellpadding="0" border="0" bgcolor="#dddddd">
							<tr>
								<td>
								<table cellspacing="0" cellpadding="2" border="0" bgcolor="#dddddd" width="794">
									<tr align="left">
										<td width="262">
							...
							<tr>
								<td rowspan="2">
								<table cellspacing="2" cellpadding="2" border="0" bgcolor="#eeeeee">
									<tr align="left">
										<td valign="bottom">
				...
				<table cellspacing="0" cellpadding="0" border="0" width="800">
					<tr>
						<td align="center">
						<table cellspacing="0" cellpadding="1" border="0" width="800" bgcolor="#416C97" class="pagetitlebar" background="<c:url value="/resources/images/blue_bg.jpg"/>">
							<tr>
								<td>
								<table cellspacing="0" cellpadding="4" border="0" width="800">
									<tr>
										...
										<div style="padding-left: 3px;">
											<input type="image" src="<c:url value="/resources/images/blue_back3.gif"/>" width="75" height="22" name="Submit" value="<spring:message code="register.return"/>" onclick="JavaScript:history.go(-1)">
										</div>
										</td>
										<td align="center" width="250">&nbsp;</td>
										<td align="right" valign="middle" width="250">
										<input type="image" src="<c:url value="/resources/images/blue_reg.gif"/>" name="Submit" value="<spring:message code="register.submit"/>">
										</td>
									</tr>
								</table>
								</td>
