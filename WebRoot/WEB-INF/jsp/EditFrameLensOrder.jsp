...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="700">
	...
	<tr>
	    ...
	    <td align="center" valign="bottom"><font size=2><b><spring:message code="lens.prism.bshort"/></b></font></td>
	    <td align="center" valign="bottom"><font size=2><b><spring:message code="lens.prism.bdirection"/></b></font></td>
	</tr>
	<tr>
        ...
        <td align="center"><spring:bind path="order.rbhprism"><input name="<c:out value="${status.expression}"/>" type="text" value="<c:out value="${status.value}"/>" tabindex="3" size="10"></spring:bind></td>
        <td align="center">
			<spring:bind path="order.rbhpd">
				<select name="<c:out value="${status.expression}"/>">
					<option value="" <c:if test="${empty status.value}">selected</c:if>><spring:message code="list.select"/></option>
					<option value="UP" <c:if test="${'UP' == status.value}">selected</c:if>>UP</option>
					<option value="DOWN" <c:if test="${'DOWN' == status.value}">selected</c:if>>DOWN</option>
	...
	<tr>
        ...
        <td align="center"><spring:bind path="order.lbhprism"><input name="<c:out value="${status.expression}"/>" type="text" value="<c:out value="${status.value}"/>" tabindex="3" size="10"></spring:bind></td>
        <td align="center">
			<spring:bind path="order.lbhpd">
				<select name="<c:out value="${status.expression}"/>">
					<option value="" <c:if test="${empty status.value}">selected</c:if>><spring:message code="list.select"/></option>
					<option value="UP" <c:if test="${'UP' == status.value}">selected</c:if>>UP</option>
					<option value="DOWN" <c:if test="${'DOWN' == status.value}">selected</c:if>>DOWN</option>
    ...
    <tr>
    	<td colspan="8" valign="middle"><font size="4"><b><spring:message code="lens.pow"/></b></font></td>
    </tr>
	<tr>
		<td colspan="8" height="0">
		<hr>
	...
	<tr>
	   <td></td>
	   <td colspan="2"><font size="2"><b><spring:message code="lens.verdis"/></b></font></td>
	   <td colspan="2"><font size="2"><b><spring:message code="lens.pantilt"/></b></font></td>
	   <td colspan="2"><font size="2"><b><spring:message code="lens.wrapangle"/></b></font></td>
       <td></td>
    </tr>	
	<tr>
	   <td></td>
	   <td colspan="2"><spring:bind path="order.verdis"><input name="<c:out value="${status.expression}"/>" type="text" value="<c:out value="${status.value}"/>" tabindex="4" size="20"></spring:bind></td>
	   <td colspan="2"><spring:bind path="order.pantilt"><input name="<c:out value="${status.expression}"/>" type="text" value="<c:out value="${status.value}"/>" tabindex="4" size="20"></spring:bind></td>
	   <td colspan="2"><spring:bind path="order.wrapangle"><input name="<c:out value="${status.expression}"/>" type="text" value="<c:out value="${status.value}"/>" tabindex="4" size="20"></spring:bind></td>
       <td></td>
    </tr>	
	</c:if>
        	...
        	<table border="0">
        		...
        		<tr>
	        		<td valign="top">
	        			...
	        			<label style="display:none;"><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="5" value="None" <c:if test="${empty status.value||status.value=='None'}">checked</c:if>><spring:message code="none"/></label>
					...
					<td valign="top">
						...
						<label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="5" value="None" <c:if test="${empty status.value||status.value=='None'}">checked</c:if>><spring:message code="material.none"/></label><br>
			...
			<table>
				...
				<tr>
					<td valign="top">
		              	...
		              	<c:if test="${lang.language != 'zh'}">
		              	    <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Asph. SV" <c:if test="${'Asph. SV' == status.value}">checked</c:if>><spring:message code="lenstype.AsphSV"/></label><br>	
		              	</c:if>
		              	<label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="FT 25" <c:if test="${'FT 25' == status.value}">checked</c:if>><spring:message code="lenstype.ft25"/></label><br>
		              	...
		              	<label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Round 38" <c:if test="${'Round 38' == status.value}">checked</c:if>><spring:message code="lenstype.round38"/></label><br>	              		
		              	...
		              	<label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Executive Bifocal" <c:if test="${'Executive Bifocal' == status.value}">checked</c:if>><spring:message code="lenstype.ExecutiveBifocal"/></label><br>
	              	</td>
	              	<td valign="top">
		              	...
		              	<label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Asph. Prog/Short" <c:if test="${'Asph. Prog/Short' == status.value}">checked</c:if>><spring:message code="lenstype.AsphProgShort"/></label><br>
		               ...
		               <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Prog/Office" <c:if test="${'Prog/Office' == status.value}">checked</c:if>><spring:message code="lenstype.office"/></label><br>
		              	<c:if test="${lang.language == 'zh'}">
		              	    ...
		              	    <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="King Kong" <c:if test="${'King Kong' == status.value}">checked</c:if>><spring:message code="lenstype.kingkong"/></label><br>
		              	</c:if>
	              	 <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Free Form-HD" <c:if test="${'Free Form-HD' == status.value}">checked</c:if>><spring:message code="lenstype.FeeFormHD"/></label><br>	
	              	 <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Free Form-MD" <c:if test="${'Free Form-MD' == status.value}">checked</c:if>><spring:message code="lenstype.FeeFormMD"/></label><br>	
	              	 <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Free Form-SD" <c:if test="${'Free Form-SD' == status.value}">checked</c:if>><spring:message code="lenstype.FeeFormSD"/></label><br>	
	              	 <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Free Form-Ultra Short" <c:if test="${'Free Form-Ultra Short' == status.value}">checked</c:if>><spring:message code="lenstype.FreeFormUltraShort"/></label><br>
	              	 <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Office Executive" <c:if test="${'Office Executive' == status.value}">checked</c:if>><spring:message code="lenstype.OfficeExecutive"/></label><br>
		             <c:if test="${lang.language != 'zh'}">
		               <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Free Form SV" <c:if test="${'Free Form SV' == status.value}">checked</c:if>><spring:message code="lenstype.FeeFormSV"/></label><br>	
	              	   <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Wrap SV" <c:if test="${'Wrap SV' == status.value}">checked</c:if>><spring:message code="lenstype.WrapSV"/></label><br>
	              	   <label><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="6" value="Wrap Prog" <c:if test="${'Wrap Prog' == status.value}">checked</c:if>><spring:message code="lenstype.WrapProg"/></label><br>
		              </c:if>
		            </td>
		        </tr>
		    </table>
         			...
         			<td>
						<table align="left" cellpadding="0" cellspacing="0">
							...
							<tr>
						        ...
						        <td><input name="<c:out value="${status.expression}"/>" type="radio" tabindex="7" value="<spring:message code="treatment.treat.unc"/>" <c:if test="${tvalue == status.value}">checked</c:if>/></td>
						        <td>&nbsp;</td>
					        </tr>
					        <tr>
									...
									<td>
										<spring:bind path="order.tintcolor1">
											<select name="<c:out value="${status.expression}"/>">
												...
												<option value="G-15 - 85%" <c:if test="${'G-15 - 85%' == status.value}">selected</c:if>><spring:message code="tintcolor.g1585"/></option>
	...
	<tr>
		<td align="left" <c:if test="${lang.language != 'zh'}">colspan="5"</c:if><c:if test="${lang.language == 'zh'}">colspan="8"</c:if>>
		...
		<c:if test="${lang.language != 'zh'}">
		<td align="right" style="padding-right:10px; color:red;"><spring:message code="lens.price"/>:
		<spring:bind path="order.tframe">
		<input type="hidden" id="_tframe" name="<c:out value="${status.expression}"/>" value="${status.value}"/>
		</spring:bind>
		</td>
		<td align="left" colspan="2">$
		<spring:bind path="order.price">
		<input type="text" id="_price" name="<c:out value="${status.expression}"/>" value="<c:choose><c:when test="${status.value ==null}">0</c:when><c:otherwise>${status.value}</c:otherwise></c:choose>" size="10" readOnly />
		</spring:bind>
		</td>
		</c:if>
	</tr>
